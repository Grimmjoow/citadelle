...
public class TestNavigatrice {
	...
	public void test2(){
		...
		Test.test(navigatrice.getJoueur().nbQuartiersReelDansMain() == 0 && navigatrice.getJoueur().nbPieces()==0,
				"test du nombre de cartes  dans la main et de pieces avant l'utilisation du pouvoir");			
		navigatrice.utiliserPouvoirAvatar();
		Test.test(navigatrice.getJoueur().nbQuartiersReelDansMain() == 4 ||navigatrice.getJoueur().nbPieces()==4,
