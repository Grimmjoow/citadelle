...
public class TestPatricien {
	...
	public void test6(){
		...
		Test.test(patricien.getJoueur().nbQuartiersReelDansMain() == 3,"test du nombre de quartiers apr�s ajout");
	}
	public void test7(){
		...
		Test.test(patricien.getJoueur().nbQuartiersReelDansCite() == 3,
	...
	public void test8(){
		...
		patricien.setJoueur(joueur);
		patricien.ajouterPieces();
		Test.test(patricien.getJoueur().nbQuartiersReelDansMain() == 0,
		...
		patricien.construire(quartier3);		
		patricien.percevoirRessourcesSpecifiques();
		Test.test(patricien.getJoueur().nbQuartiersReelDansMain() == 1,
