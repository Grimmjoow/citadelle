...
public class Magicienne extends Personnage {
    ...
    /**
     * Méthode pour utiliser le pouvoir de la Magicienne.
     */
                ...
                if (oui) {
                    ...
                    do {
                        ...
                        if (this.getPlateau().getJoueur(choix - 1).equals(this.getJoueur())) {
                            ...
                            ArrayList<Quartier> copieTableauVole = new ArrayList<Quartier>(
                                    this.getPlateau().getJoueur(choix - 1).getMain());
                    ...
                    if (nb == this.getJoueur().nbQuartiersReelDansMain()) {
                        ...
                        for (int i = 0; i < nb; i++) {
                            ...
                            System.out.println("Sélectionnez une carte à échanger : ");
    ...
    /**
     * Méthode pour utiliser le pouvoir avatar de la Magicienne.
     */
        ...
        if (this.getJoueur() != null && !this.getAssassine()) {
            ...
            do {
                ...
                if (oui == 0) {
                    ...
                    System.out.println("Combien de cartes voulez-vous remplacer ?");
                    int nb = random.nextInt(this.getJoueur().nbQuartiersReelDansMain() + 1 - 0);
    ...
    /**
     * Méthode pour activer le pouvoir de la Magicienne en réponse à la Sorcière.
     * @param joueurSorciere Joueur cible de l'activation du pouvoir.
     */
    @Override
