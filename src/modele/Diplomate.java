...
/**
 * La classe Diplomate représente le personnage Diplomate du jeu.
 */
public class Diplomate extends Personnage {

    /**
     * Constructeur de la classe Diplomate.
     */
    public Diplomate() {
    ...
    /**
     * Utilise le pouvoir du Diplomate (échange de quartiers avec un autre joueur).
     */
