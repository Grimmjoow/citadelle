...
public class Espion extends Personnage {
    ...
    // Constructeur par défaut de la classe Espion
    public Espion() {
    ...
    // Méthode pour utiliser le pouvoir spécial de l'Espion avec un choix aléatoire du joueur et du type de quartier
